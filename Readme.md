...
현대인의 절반 이상이 '문해력 부족으로 업무상 어려움을 겪은 적이 있다'라는 조사 결과도 있습니다.  
이처럼 _현대인의 **문해력** 부족_ 문제는 중요한 사회 이슈입니다.

저희는 이러한 문해력 부족 문제를 해결하기 위한 고민 끝에 서당독을 제작하게 되었습니다.  
서당독은 **관심 키워드** 기반으로 **뉴스**를 **추천**하고, **문제**를 풀어 **문해력을 높일 수 있는 웹 서비스**입니다.
...
- 뉴스 본문에서 추출한 주요 **`키워드`**
- 뉴스를 표시하면서 읽을 수 있는 <b>`하이라이트`</b> 기능 제공
- 단어를 클릭하여 <b>`단어의 의미`</b>를 확인하고 단어를 **`단어장`** 에 저장
- 뉴스의 내용을 바탕으로 이해도를 체크하기 위한 **`문제풀기`** 및 **`요약하기`**
- 문제를 풀고난 후 **`정답 채점`** 및 <b>`네이버 요약봇의 요약문`</b>과 비교

![detail](./image/detail.gif)

## 단어장 & 스피드 퀴즈

- <b>`뉴스 상세 보기`</b>에서 저장한 단어들을 단어장에서 관리
- 단어를 클릭하여 <b>`단어 상세 보기`</b>
- 저장한 단어들로 <b>`스피드 퀴즈`</b> 게임 제공
...
- <b>`최근 본 기사`</b>와 <b>`최근 푼 기사`</b> 내역 제공
- 문제 풀이의 정답률과 출석률에 따른 <b>`능력치`</b> 제공
...
- 뉴스 기사 본문을 이해하기 위한 기능 제공
  ...
  - 클릭하여 <b>`단어 의미 검색`</b>
- 뉴스 기사 문제 제공
  - 뉴스 기사의 본문 내용에 따른 GPT 자동 생성 <b>`뉴스 기사 문제`</b> 제공
  - 네이버 요약봇의 <b>`요약문`</b> 제공
- 어휘력을 기르기 위한 기능 제공
  - <b>`단어장`</b> 저장
  - <b>`스피드 퀴즈`</b>
...
| [정창휘](https://github.com/JungChnagHwi) | 백엔드       | DB 설계, 메인페이지, 단어장 및 게임 API 설계, UI/UX 설계, 디자인               |
