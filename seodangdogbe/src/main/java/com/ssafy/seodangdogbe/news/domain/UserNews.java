...
public class UserNews {
    ...
    // newsSeq와 userSeq를 받는 생성자
    public UserNews(int userSeq, Long newsSeq) {
        this.user = new User(userSeq); // User 엔티티 생성 후 연결
        this.news = new News(newsSeq); // News 엔티티 생성 후 연결
    }
}
